...
function Signup() {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const res = await axios.post("http://localhost:3045/user/signup", userInfo);
  ...
  return (
    <>
      <div className="h-screen flex justify-center items-center bg-zinc-100  dark:bg-slate-900 dark:text-white dark:border">
